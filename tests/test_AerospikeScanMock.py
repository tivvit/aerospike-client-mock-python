...
class TestAerospikeScanMock(unittest.TestCase):
    ...
    def test_scan(self):
        ...
        scan.select('a', 'c')
        self.assertEqual([(('a', 'b', 3), {'a': 3, 'c': None}, {'gen': 1, 'ttl': 0}), (('a', 'b', 2), {'a': 2, 'c': None}, {'gen': 1, 'ttl': 0}), (('a', 'b', 1), {'a': 1, 'c': None}, {'gen': 1, 'ttl': 0})], scan.results())
    ...
    def test_scan_namespace(self):
        ...
        self.assertEqual([(('a', 'b', 3), {'a': 3, 'b': 3}, {'gen': 1, 'ttl': 0}),
            ...
            (('a', 'b', 1), {'a': 1, 'b': 1}, {'gen': 1, 'ttl': 0})], scan.results())
