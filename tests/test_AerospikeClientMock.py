...
class TestAerospikeClientMock(unittest.TestCase):
    ...
    def test_incr(self):
        ...
        self.assertEqual((('a', 'b', 'c'), {'a': 2}, {'gen': 2, 'ttl': 0}),
                         asm.get(key))
        asm.increment(key, "a", 1)
        self.assertEqual({('a', 'b', 'c'): {'a': 3}}, asm.dump())
        self.assertEqual((('a', 'b', 'c'), {'a': 3}, {'gen': 3, 'ttl': 0}),
                         asm.get(key))
    ...
    def test_incr_value(self):
        ...
        self.assertEqual({('a', 'b', 'c'): {'a': 3}}, asm.dump())
        self.assertEqual((('a', 'b', 'c'), {'a': 3}, {'gen': 2, 'ttl': 0}),
                         asm.get(key))
    ...
    def test_select(self):
        ...
        self.assertEqual(
            (('a', 'b', 'c'), {'a': 1, 'c': 3}, {'gen': 1, 'ttl': 0}),
            asm.select(key, ["a", "c"]))
        # test if not changing gen
        self.assertEqual(
            (('a', 'b', 'c'), {'a': 1, 'd': None}, {'gen': 1, 'ttl': 0}),
            asm.select(key, ["a", "d"]))
    ...
    def test_remove_bin(self):
        ...
        self.assertEqual(
            (('a', 'b', 'c'), {'a': 1, 'c': 1}, {'gen': 2, 'ttl': 0}),
            asm.get(key))
        asm.remove_bin(key, ["c"])
        self.assertEquals({('a', 'b', 'c'): {'a': 1}}, asm.dump())
        self.assertEqual((('a', 'b', 'c'), {'a': 1}, {'gen': 3, 'ttl': 0}),
                         asm.get(key))
    ...
    def test_get_many(self):
        ...
        self.assertEqual(
            {
                1: (('a', 'b', 1), {'a': 1}, {'gen': 1, 'ttl': 0}),
                2: (('a', 'b', 2), {'a': 2}, {'gen': 1, 'ttl': 0}),
                3: (('a', 'b', 3), {'a': 3}, {'gen': 1, 'ttl': 0}),
                4: (('a', 'b', 4), {'a': 4}, {'gen': 1, 'ttl': 0}),
                5: None
            }, asm.get_many(keys))
    ...
    def test_select_many(self):
        ...
        self.assertEqual(
            {
                1: (('a', 'b', 1), {'a': 1, 'b': 1}, {'gen': 1, 'ttl': 0}),
                2: (('a', 'b', 2), {'a': 2, 'b': 2}, {'gen': 1, 'ttl': 0}),
                3: (('a', 'b', 3), {'a': 3, 'b': 3}, {'gen': 1, 'ttl': 0}),
                4: (('a', 'b', 4), {'a': 4, 'b': 4}, {'gen': 1, 'ttl': 0}),
                5: None
            }, asm.select_many(keys, ["a", "b"]))
        self.assertEqual(
            {
                1: (('a', 'b', 1), {'b': 1}, {'gen': 1, 'ttl': 0}),
                2: (('a', 'b', 2), {'b': 2}, {'gen': 1, 'ttl': 0}),
                3: (('a', 'b', 3), {'b': 3}, {'gen': 1, 'ttl': 0}),
                4: (('a', 'b', 4), {'b': 4}, {'gen': 1, 'ttl': 0}),
                5: None
